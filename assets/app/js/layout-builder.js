                                ...
                                if (t.message) o.stopWithNotify(t.message);
                                    ...
                                    var a = setInterval(function() {
                                        $.ajax("index.php", {
                                            ...
                                            .done(function(e) {
                                                var t = JSON.parse(e);
                                                void 0 !== t && 1 === t.export_status && $("<iframe/>")
                                                    .attr({
    ...
    window.envato = {
        ...
        reCaptchaVerified: function() {
            return $.ajax("https://keenthemes.com/metronic/preview/inc/api/envato.php?recaptcha", {
                ...
                .fail(function() {
                    grecaptcha.reset(), $("#alert-message")
        ...
        verifyEvent: function() {
            ...
            $("#purchase-code")
                ...
                .val(envato.getItem("purchase_code")), $("#builder_export")
                .closest(".dropdown")
                .find(".dropdown-item")
                .click(function(e) {
                    e.preventDefault(), t = $(this), envato.isVerified() || ($("#m-modal-purchase")
                        .modal("show"), $("#alert-message")
                        .addClass("m--hide"), grecaptcha.reset())
                }), $("#submit-verify")
                .click(function(e) {
                    e.preventDefault(), envato.reCaptchaVerified()
                        .done(function(e) {
                            e.success ? ($('[data-dismiss="modal"]')
                                .trigger("click"), $(t)
                                .trigger("click")) : (grecaptcha.reset(), $("#alert-message")
                                .removeClass("alert-success m--hide")
                                .addClass("alert-danger")
                                .html("Invalid reCaptcha validation"))
                        })
        ...
        o.init(), $('[href^="#m_builder_"]')
            ...
            .click(function(e) {
                ...
                $(t)
                    ...
                    .closest(".m-form__actions")
                    .find(".btn")
                    .prop("disabled", !0), $.ajax("index.php?demo=" + $(t)
                        .data("demo"), {
                            method: "POST",
                            data: $("[name]")
                                .serialize()
