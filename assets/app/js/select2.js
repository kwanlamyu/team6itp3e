var Select2 = {
    init: function() {
        $("#m_select2_1, #companyValue_validate").select2({
        ...
        }), $("#companyValue2_1, #companyValue2_2, #companyValue2_3, #companyValue2_4").select2({
        ...
        }), $("#companyValue0").select2({
            placeholder: "Select an option",
            minimumResultsForSearch: 1 / 0
        }), $("#companyValue1").select2({
            placeholder: "Add a tag",
            tags: !0
        }), $(".m-select2-general").select2({
            placeholder: "Select an option"
        }), $("#m_select2_modal").on("shown.bs.modal", function() {
            $("#companyValue_modal").select2({
                placeholder: "Select a state"
