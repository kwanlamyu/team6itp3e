var SnippetLogin = function() {
    var s = $("#m_login"),
        n = function(e, i, a) {
            ...
            e.find(".alert")
                .remove(), l.prependTo(e), mUtil.animateClass(l[0], "fadeIn animated"), l.find("span")
                .html(a)
        },
        o = function() {
        ...
        e = function() {
            $("#m_login_forget_password")
                ...
                .click(function(e) {
					alert("Login Signup Cancel");
                    e.preventDefault(), o()
                })
        };
    return {
        init: function() {
            e(), $("#m_login_signin_submit")
                .click(function(e) {
					alert("Sign In Submit");
                    e.preventDefault();
                    var t = $(this),
                        r = $(this)
                        .closest("form");
                    ...
                    }), r.valid() && (t.addClass("m-loader m-loader--right m-loader--light")
                        .attr("disabled", !0), r.ajaxSubmit({
                            url: "",
                            success: function(e, i, a, l) {
                                setTimeout(function() {
                                    t.removeClass("m-loader m-loader--right m-loader--light")
                                        .attr("disabled", !1), n(r, "danger", "Incorrect username or password. Please try again.")
                                }, 2e3)
                            }
                        }))
                    ...
                    r.validate({
                        ...
                        .attr("disabled", !0), r.ajaxSubmit({
                            ...
                            success: function(e, i, a, l) {
                                setTimeout(function() {
                                    t.removeClass("m-loader m-loader--right m-loader--light")
                                        .attr("disabled", !1), r.clearForm(), r.validate()
                                        .resetForm(), o();
                                    var e = s.find(".m-login__signin form");
                                    e.clearForm(), e.validate()
                                        .resetForm(), n(e, "success", "Thank you. To complete your registration please check your email.")
                                }, 2e3)
                            }
                        }))
                        ...
                        .attr("disabled", !0), r.ajaxSubmit({
                            ...
                            success: function(e, i, a, l) {
                                setTimeout(function() {
                                    ...
                                    var e = s.find(".m-login__signin form");
                                    e.clearForm(), e.validate()
                                        .resetForm(), n(e, "success", "Cool! Password recovery instruction has been sent to your email.")
                                }, 2e3)
                            }
                        }))
                })
