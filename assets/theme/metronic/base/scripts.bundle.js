                        ...
                        .data("tabs-initialized") && ($(this)
                            .click(function(t) {
                                ...
                                a.find(".m-tabs__item.m-tabs__item--active")
                                    .removeClass("m-tabs__item--active"), e.addClass("m-tabs__item--active"), n.find(".m-tabs-content__item.m-tabs-content__item--active")
                                    .removeClass("m-tabs-content__item--active"), o.addClass("m-tabs-content__item--active")
                            }), $(this)
                            .data("tabs-initialized", !0))
                })
        };
    return {
        init: function(t) {
        ...
        initComponents: function() {
            jQuery.event.special.touchstart = {
                ...
                .on("click", "[data-close=alert]", function() {
                    $(this)
                        .closest(".alert")
                        .hide()
                }), l(), $(".custom-file-input")
        ...
        scrollTo: function(t, e) {
            el = $(t);
            var a = el && 0 < el.length ? el.offset()
                .top : 0;
            a += e || 0, jQuery("html,body")
                .animate({
                    scrollTop: a
                }, "slow")
        },
        ...
        alert: function(t) {
            ...
            return t.reset && $(".custom-alerts")
                ...
                .append(a) : $(t.container)
                .prepend(a) : 1 === $(".page-fixed-main-content")
                ...
                .after(a) : 0 < $(".page-bar")
                .size() ? $(".page-bar")
                .after(a) : $(".page-breadcrumb, .breadcrumbs")
                .after(a), t.focus && mApp.scrollTo($("#" + e)), 0 < t.closeInSeconds && setTimeout(function() {
                    $("#" + e)
                        .remove()
        ...
        block: function(t, e) {
            ...
            if ("spinner" == (e = $.extend(!0, {
                ...
                .type ? o = '<div class="m-spinner ' + (a = e.skin ? "m-spinner--skin-" + e.skin : "") + " " + (n = e.state ? "m-spinner--" + e.state : "") + '"></div' : (a = e.skin ? "m-loader--skin-" + e.skin : "", n = e.state ? "m-loader--" + e.state : "", size = e.size ? "m-loader--" + e.size : "", o = '<div class="m-loader ' + a + " " + n + " " + size + '"></div'), e.message && 0 < e.message.length) {
                var l = "m-blockui " + (!1 === e.shadow ? "m-blockui-no-shadow" : "");
                html = '<div class="' + l + '"><span>' + e.message + "</span><span>" + o + "</span></div>";
                i = document.createElement("div");
                mUtil.get("body")
                    .prepend(i), mUtil.addClass(i, l), i.innerHTML = "<span>" + e.message + "</span><span>" + o + "</span>", e.width = mUtil.actualWidth(i) + 10, mUtil.remove(i), "body" == t && (html = '<div class="' + l + '" style="margin-left:-' + e.width / 2 + 'px;"><span>' + e.message + "</span><span>" + o + "</span></div>")
            } else html = o;
            var r = {
                message: html,
                centerY: e.centerY,
            ...
            "body" == t ? (r.css.top = "50%", $.blockUI(r)) : (i = $(t))
                .block(r)
        },
        unblock: function(t) {
            t && "body" != t ? $(t)
...
$(document)
    .ready(function() {
        ...
        t.matches = t.matches || t.matchesSelector || t.webkitMatchesSelector || t.msMatchesSelector || function(t) {
            for (var e = (this.parentNode || this.document)
                    .querySelectorAll(t), a = -1; e[++a] && e[a] != this;);
            return !!e[a]
        }
...
var mUtil = function() {
    ...
    return {
        ...
        getURLParam: function(t) {
            var e, a, n = window.location.search.substring(1)
                .split("&");
        ...
        getUniqueID: function(t) {
            return t + Math.floor(Math.random() * (new Date)
                .getTime())
        },
        ...
        isset: function(t, e) {
            var a;
            if (-1 !== (e = e || "")
                .indexOf("[")) throw new Error("Unsupported object path notation.");
            e = e.split(".");
            do {
        ...
        hasClass: function(t, e) {
            if (t) return t.classList ? t.classList.contains(e) : new RegExp("\\b" + e + "\\b")
                .test(t.className)
        },
        ...
        triggerCustomEvent: function(t, e, a) {
            ...
            else(n = document.createEvent("CustomEvent"))
                .initCustomEvent(e, !0, !0, a);
            t.dispatchEvent(n)
        },
        trim: function(t) {
            return t.trim()
        ...
        css: function(t, e, a) {
            if (t = mUtil.get(t), void 0 !== a) t.style[e] = a;
                ...
                var n = (t.ownerDocument || document)
                    .defaultView;
                if (n && n.getComputedStyle) return e = e.replace(/([A-Z])/g, "-$1")
                    .toLowerCase(), n.getComputedStyle(t, null)
                    .getPropertyValue(e);
        ...
        slide: function(e, t, a, n, o) {
            if (!(!e || "up" == t && !1 === mUtil.visible(e) || "down" == t && !0 === mUtil.visible(e))) {
                ...
                var i = mUtil.actualHeight(e),
                    l = !1,
                    r = !1;
                mUtil.css(e, "padding-top") && !0 !== mUtil.data(e)
                    .has("slide-padding-top") && mUtil.data(e)
                    .set("slide-padding-top", mUtil.css(e, "padding-top")), mUtil.css(e, "padding-bottom") && !0 !== mUtil.data(e)
                    .has("slide-padding-bottom") && mUtil.data(e)
                    .set("slide-padding-bottom", mUtil.css(e, "padding-bottom")), mUtil.data(e)
                    .has("slide-padding-top") && (l = parseInt(mUtil.data(e)
                        .get("slide-padding-top"))), mUtil.data(e)
                    .has("slide-padding-bottom") && (r = parseInt(mUtil.data(e)
                        .get("slide-padding-bottom"))), "up" == t ? (e.style.cssText = "display: block; overflow: hidden;", l && mUtil.animate(0, l, a, function(t) {
        ...
        g.fn.mDatatable = function(u) {
            if (0 !== g(this)
                ...
                var f = {
                    ...
                    init: function(t) {
                        var e = !1;
                        return null === t.data.source && (f.extractTable(), e = !0), f.setupBaseDOM.call(), f.setupDOM(p.table), f.spinnerCallback(!0), f.setDataSourceQuery(f.getOption("data.source.read.params.query")), g(p)
                            .on("m-datatable--on-layout-updated", f.afterRender), p.debug && f.stateRemove(f.stateId), g.each(f.getOption("extensions"), function(t, e) {
                                "function" == typeof g.fn.mDatatable[t] && new g.fn.mDatatable[t](p, e)
                            }), "remote" !== t.data.type && "local" !== t.data.type || ((!1 === t.data.saveState || !1 === t.data.saveState.cookie && !1 === t.data.saveState.webstorage) && f.stateRemove(f.stateId), "local" === t.data.type && "object" == typeof t.data.source && (p.dataSet = p.originalDataSet = f.dataMapCallback(t.data.source)), f.dataRender()), e || (f.setHeadTitle(), f.getOption("layout.footer") && f.setHeadTitle(p.tableFoot)), void 0 !== t.layout.header && !1 === t.layout.header && g(p.table)
                            .find("thead")
                            .remove(), void 0 !== t.layout.footer && !1 === t.layout.footer && g(p.table)
                            .find("tfoot")
                            .remove(), null !== t.data.type && "local" !== t.data.type || (f.setupCellField.call(), f.setupTemplateCell.call(), f.setupSubDatatable.call(), f.setupSystemColumn.call(), f.redraw()), g(window)
                            .resize(f.fullRender), g(p)
                            .height(""), g(f.getOption("search.input"))
                            .on("keyup", function(t) {
                                f.getOption("search.onEnter") && 13 !== t.which || f.search(g(this)
                                    .val())
                            }), p
                    },
                    ...
                    layoutUpdate: function() {
                        f.setupSubDatatable.call(), f.setupSystemColumn.call(), f.setupHover.call(), void 0 === u.detail && 1 === f.getDepth() && f.lockTable.call(), f.columnHide.call(), f.resetScroll(), f.isInit || (g(p)
                                .trigger("m-datatable--on-init", {
                                    table: g(p.wrap)
                                        .attr("id"),
                                    options: u
                                }), f.isInit = !0), g(p)
                                        ...
                                        0 === g(this)
                                            ...
                                            .ready(function() {
                                                ! function(t) {
                                                    if (0 < g(t)
                                                        .find(".m-datatable__lock")
                                                        .length) f.log("Locked container already exist in: ", t);
                                                    else if (0 !== g(t)
                                                            ...
                                                            .each(function() {
                                                                ...
                                                                g(this)
                                                                    ...
                                                                    .each(function() {
                                                                        var t = g(this)
                                                                            .data("locked");
                                                                        void 0 !== t ? (void 0 === t.left && !0 !== t || g(this)
                                                                                .appendTo(e), void 0 !== t.right && g(this)
                                                                                .appendTo(n)) : g(this)
                                                                            .appendTo(a)
                                                                    }), g(this)
                                                                    .remove()
                                                            }), 0 < e.lockEnabled.left.length && (g(p.wrap)
                                                                .addClass("m-datatable--lock"), g(o)
                                                                .appendTo(t)), (0 < e.lockEnabled.left.length || 0 < e.lockEnabled.right.length) && g(i)
                                                            .appendTo(t), 0 < e.lockEnabled.right.length && (g(p.wrap)
                                                                .addClass("m-datatable--lock"), g(l)
                                                                .appendTo(t))
                    ...
                    fullRender: function() {
                        f.spinnerCallback(!0), g(p.wrap)
                            .removeClass("m-datatable--loaded"), f.insertData()
                    },
                    ...
                    afterRender: function(t, e) {
                        e.table == g(p.wrap)
                            .attr("id") && g(p)
                            .ready(function() {
                                f.isLocked() || (f.redraw(), f.getOption("rows.autoHide") && (f.autoHide(), g(p.table)
                                        .find(".m-datatable__row")
                                        .css("height", ""))), g(p.tableBody)
                                    .find(".m-datatable__row")
                                    .removeClass("m-datatable__row--even"), g(p.wrap)
                                    .hasClass("m-datatable--subtable") ? g(p.tableBody)
                                    .find(".m-datatable__row:not(.m-datatable__row-detail):even")
                                    .addClass("m-datatable__row--even") : g(p.tableBody)
                                    .find(".m-datatable__row:nth-child(even)")
                                    .addClass("m-datatable__row--even"), f.isLocked() && f.redraw(), g(p.tableBody)
                                    .css("visibility", ""), g(p.wrap)
                                    .addClass("m-datatable--loaded"), f.scrollbar.call(), f.sorting.call(), f.spinnerCallback(!1)
                            })
                    },
                    hoverTimer: 0,
                    isScrolling: !1,
                            ...
                            .on("mouseenter", function() {
                                if (f.hoverTimer = setTimeout(function() {
                                    ...
                                    g(t)
                                        ...
                                        .parent()
                                        .find(".m-datatable__row:nth-child(" + e + ")")
                                        .addClass("m-datatable__row--hover")
                                }
                            })
                    ...
                    dragResize: function() {
                        ...
                        g(p.tableHead)
                            ...
                            .mousedown(function(t) {
                                s = g(this), r = !0, i = t.pageX, l = g(this)
                                    .width(), g(s)
                                    .addClass("m-datatable__cell--resizing")
                            })
                            .mousemove(function(a) {
                                if (r) {
                                    ...
                                    g(t)
                                        ...
                                        .children()
                                        .css("width", l + (a.pageX - i))
                                }
                            })
                            .mouseup(function() {
                                g(s)
                                    .removeClass("m-datatable__cell--resizing"), r = !1
                            }), g(document)
                            .mouseup(function() {
                                g(s)
                                    .removeClass("m-datatable__cell--resizing"), r = !1
                    ...
                    initHeight: function() {
                        if (u.layout.height && u.layout.scroll) {
                            var t = g(p.tableHead)
                                ...
                                .height(),
                                a = u.layout.height;
                            0 < t && (a -= t), 0 < e && (a -= e), g(p.tableBody)
                                .css("max-height", a)
                        }
                    },
                    setupBaseDOM: function() {
                        p.initialDatatable = g(p)
                            .clone(), "TABLE" === g(p)
                            .prop("tagName") ? (p.table = g(p)
                                .removeClass("m-datatable")
                                .addClass("m-datatable__table"), 0 === g(p.table)
                                .parents(".m-datatable")
                                .length && (p.table.wrap(g("<div/>")
                                        .addClass("m-datatable")
                                        .addClass("m-datatable--" + u.layout.theme)), p.wrap = g(p.table)
                                    .parent())) : (p.wrap = g(p)
                                .addClass("m-datatable")
                                .addClass("m-datatable--" + u.layout.theme), p.table = g("<table/>")
                                .addClass("m-datatable__table")
                                .appendTo(p)), void 0 !== u.layout.class && g(p.wrap)
                            .addClass(u.layout.class), g(p.table)
                            .removeClass("m-datatable--destroyed")
                            .css("display", "block"), void 0 === g(p)
                            .attr("id") && (f.setOption("data.saveState", !1), g(p.table)
                                .attr("id", mUtil.getUniqueID("m-datatable--"))), f.getOption("layout.minHeight") && g(p.table)
                            .css("min-height", f.getOption("layout.minHeight")), f.getOption("layout.height") && g(p.table)
                            .css("max-height", f.getOption("layout.height")), null === u.data.type && g(p.table)
                            .css("width", "")
                            .css("display", ""), p.tableHead = g(p.table)
                            .find("thead"), 0 === g(p.tableHead)
                            .length && (p.tableHead = g("<thead/>")
                                .prependTo(p.table)), p.tableBody = g(p.table)
                            .find("tbody"), 0 === g(p.tableBody)
                            .length && (p.tableBody = g("<tbody/>")
                                .appendTo(p.table)), void 0 !== u.layout.footer && u.layout.footer && (p.tableFoot = g(p.table)
                                .find("tfoot"), 0 === g(p.tableFoot)
                                .length && (p.tableFoot = g("<tfoot/>")
                                    .appendTo(p.table)))
                    },
                    setupCellField: function(t) {
                        void 0 === t && (t = g(p.table)
                            .children());
                        var a = u.columns;
                    ...
                    setupTemplateCell: function(t) {
                        ...
                        g(t)
                            ...
                            .each(function(i, t) {
                                ...
                                "function" == typeof a && a(g(t), l, i), void 0 === l && (l = {}, g(t)
                                        .find(".m-datatable__cell")
                                        .each(function(t, a) {
                                    ...
                                    .each(function(t, a) {
                                        ...
                                        if (void 0 !== e && void 0 !== e.template) {
                                            ...
                                            o.innerHTML = n, g(a)
                                                .html(o), void 0 !== e.overflow && (g(o)
                                                    .css("overflow", e.overflow), g(o)
                                            ...
                                            if (void 0 !== e) {
                                                ...
                                                if (void 0 !== e.selector && !1 !== e.selector) {
                                                    if (0 < g(a)
                                                        ...
                                                        .length) return;
                                                    g(a)
                                                        .addClass("m-datatable__cell--check");
                                                    var o = g("<label/>")
                                                        ...
                                                        .append(g("<input/>")
                                                            ...
                                                            .on("click", function() {
                                                                g(this)
                                                                    .is(":checked") ? f.setActive(this) : f.setInactive(this)
                                                            }))
                                                        .append(g("<span/>"));
                                                    void 0 !== e.selector.class && g(o)
                                                        .addClass(e.selector.class), g(a)
                                                        .children()
                                                        .html(o)
                                                }
                                ...
                                if (void 0 !== e && void 0 !== e.selector && !1 !== e.selector) {
                                    ...
                                    var n = g("<label/>")
                                        ...
                                        .append(g("<input/>")
                                            ...
                                            .on("click", function() {
                                                g(this)
                                                    .is(":checked") ? f.setActiveAll(!0) : f.setActiveAll(!1)
                                            }))
                                        .append(g("<span/>"));
                                    void 0 !== e.selector.class && g(n)
                                        .addClass(e.selector.class), g(a)
                                        .children()
                                        .html(n)
                                }
                            };
                            u.layout.header && t(g(p.tableHead)
                                .find(".m-datatable__row")
                                .first()), u.layout.footer && t(g(p.tableFoot)
                                .find(".m-datatable__row")
                                .first())
                        }
                    },
                    adjustCellsWidth: function() {
                        ...
                        if (0 < e) {
                            ...
                            o <= f.offset && (o = f.offset), g(p.table)
                                .find(".m-datatable__row")
                                .find(".m-datatable__cell:visible")
                                .each(function(t, e) {
                                    var a = o,
                                ...
                                for (var a = g(e)
                                    ...
                                    if (0 < g(o)
                                        ...
                                        var i = Math.max.apply(null, g(o)
                                            ...
                                            .get());
                                        g(o)
                                            .css("height", Math.ceil(parseInt(i)))
                                    }
                                }
                            })
                    },
                    setupDOM: function(t) {
                        g(t)
                            .find("> thead")
                            .addClass("m-datatable__head"), g(t)
                            .find("> tbody")
                            .addClass("m-datatable__body"), g(t)
                            .find("> tfoot")
                            .addClass("m-datatable__foot"), g(t)
                            .find("tr")
                            .addClass("m-datatable__row"), g(t)
                            .find("tr > th, tr > td")
                            .addClass("m-datatable__cell"), g(t)
                            .find("tr > th, tr > td")
                            .each(function(t, e) {
                                0 === g(e)
                                    .find("span")
                    ...
                    scrollbar: function() {
                        var n = {
                            ...
                            init: function() {
                                ...
                                var t = mUtil.getViewPort()
                                    .width;
                                if (u.layout.scroll) {
                                    g(p.wrap)
                                        .addClass("m-datatable--scroll");
                                    var e = g(p.tableBody)
                                        .find(".m-datatable__lock--scroll");
                                    0 < g(e)
                                        .find(".m-datatable__row")
                                        .length && 0 < g(e)
                                        .length ? (n.scrollHead = g(p.tableHead)
                                            .find("> .m-datatable__lock--scroll > .m-datatable__row"), n.scrollFoot = g(p.tableFoot)
                                            .find("> .m-datatable__lock--scroll > .m-datatable__row"), n.tableLocked = g(p.tableBody)
                                            .find(".m-datatable__lock:not(.m-datatable__lock--scroll)"), t > mUtil.getBreakpoint("lg") ? n.mCustomScrollbar(e) : n.defaultScrollbar(e)) : 0 < g(p.tableBody)
                                        .find(".m-datatable__row")
                                        .length && (n.scrollHead = g(p.tableHead)
                                            .find("> .m-datatable__row"), n.scrollFoot = g(p.tableFoot)
                                            .find("> .m-datatable__row"), t > mUtil.getBreakpoint("lg") ? n.mCustomScrollbar(p.tableBody) : n.defaultScrollbar(p.tableBody))
                                } else g(p.table)
                                    .css("overflow-x", "auto")
                            },
                            defaultScrollbar: function(t) {
                                g(t)
                                    .css("overflow", "auto")
                                    .css("max-height", f.getOption("layout.height"))
                            ...
                            onScrolling: function(t) {
                                var e = g(this)
                                    ...
                                    .scrollTop();
                                g(n.scrollHead)
                                    .css("left", -e), g(n.scrollFoot)
                                    .css("left", -e), g(n.tableLocked)
                                    .each(function(t, e) {
                                        g(e)
                                            .css("top", -a)
                                    })
                            ...
                            mCustomScrollbar: function(t) {
                                ...
                                var a = g.extend({}, n.mcsOptions, {
                                    axis: e,
                                    setHeight: g(p.tableBody)
                                        .height(),
                                    callbacks: {
                                        whileScrolling: function() {
                                            var a = this.mcs;
                                            g(n.scrollHead)
                                                .css("left", a.left), g(n.scrollFoot)
                                                .css("left", a.left), g(n.tableLocked)
                                                .each(function(t, e) {
                                                    g(e)
                                                        .css("top", a.top)
                                                }), clearTimeout(f.hoverTimer), f.isScrolling = !0
                                ...
                                !0 === f.getOption("layout.smoothScroll.scrollbarShown") && g(t)
                                    .attr("data-scrollbar-shown", "true"), f.mCustomScrollbar(t, a)
                            }
                        };
                        return n.init(), n
                    },
                    mCustomScrollbar: function(t, e) {
                        g(p.tableBody)
                            .css("overflow", ""), f.destroyScroller(g(p.table)
                                .find(".mCustomScrollbar")), g(t)
                            .mCustomScrollbar(e)
                    },
                    setHeadTitle: function(t) {
                        ...
                        void 0 === o && (o = document.createElement("tr"), t.appendChild(o)), g.each(e, function(t, e) {
                            var a = i[t];
                            if (void 0 === a && (a = document.createElement("th"), o.appendChild(a)), void 0 !== e.title && (a.innerHTML = e.title, a.setAttribute("data-field", e.field), mUtil.addClass(a, e.class), g(a)
                                    .data(e)), void 0 !== e.attr && g.each(e.attr, function(t, e) {
                                    a.setAttribute(t, e)
                                }), void 0 !== e.textAlign) {
                    ...
                    dataRender: function(t) {
                        ...
                        var n = function() {
                                ...
                                return p.dataSet = g(p.dataSet)
                                    .slice(e, a), t
                            },
                            e = function(t) {
                                var e = function(e, a) {
                                    g(e.pager)
                                        .hasClass("m-datatable--paging-loaded") || (g(e.pager)
                                            .remove(), e.init(a)), g(e.pager)
                                        .off()
                                        .on("m-datatable--on-goto-page", function(t) {
                                            g(e.pager)
                                                .remove(), e.init(a)
                                        });
                                    var t = Math.max(a.perpage * (a.page - 1), 0),
                                        n = Math.min(t + a.perpage, a.total);
                                    f.localDataUpdate(), p.dataSet = g(p.dataSet)
                                        .slice(t, n), f.insertData()
                                };
                                if (g(p.wrap)
                                    .removeClass("m-datatable--error"), u.pagination)
                        ...
                        "local" === u.data.type || void 0 === u.data.source.read && null !== p.dataSet || !1 === u.data.serverSorting && "sort" === t || !1 === u.data.serverFiltering && "search" === t ? e() : f.getData()
                            .done(e)
                    },
                    insertData: function() {
                        p.dataSet = p.dataSet || [];
                        ...
                        if (g.each(p.dataSet, function(t, e) {
                                ...
                                a.setAttribute("data-row", t), g(a)
                                    .data("obj", e), void 0 !== d[t] && g.each(d[t], function() {
                            ...
                            f.destroyScroller(g(p.table)
                                .find(".mCustomScrollbar"));
                            var n = document.createElement("span");
                            mUtil.addClass(n, "m-datatable--error"), n.innerHTML = f.getOption("translate.records.noRecords"), c.appendChild(n), g(p.wrap)
                                .addClass("m-datatable--error m-datatable--loaded"), f.spinnerCallback(!1)
                        }
                        g(p.tableBody)
                            .replaceWith(c), p.tableBody = c, f.setupDOM(p.table), f.setupCellField([p.tableBody]), f.setupTemplateCell(p.tableBody), f.layoutUpdate()
                    },
                    updateTableComponents: function() {
                        p.tableHead = g(p.table)
                            .children("thead"), p.tableBody = g(p.table)
                            .children("tbody"), p.tableFoot = g(p.table)
                            .children("tfoot")
                    },
                    getData: function() {
                        f.spinnerCallback(!0);
                        ...
                        return g.ajax(t)
                            .done(function(t, e, a) {
                                p.lastResponse = t, p.dataSet = p.originalDataSet = f.dataMapCallback(t), f.setAutoColumns(), g(p)
                                    .trigger("m-datatable--on-ajax-done", [p.dataSet])
                            })
                            .fail(function(t, e, a) {
                                f.destroyScroller(g(p.table)
                                        .find(".mCustomScrollbar")), g(p)
                                    .trigger("m-datatable--on-ajax-fail", [t]), g(p.tableBody)
                                    .html(g("<span/>")
                                        .addClass("m-datatable--error")
                                        .html(f.getOption("translate.records.noRecords"))), g(p.wrap)
                                    .addClass("m-datatable--error m-datatable--loaded"), f.spinnerCallback(!1)
                            })
                            .always(function() {})
                    },
                    paging: function(t, e) {
                        var m = {
                            ...
                            callback: null,
                            init: function(t) {
                                m.meta = t, m.meta.pages = Math.max(Math.ceil(m.meta.total / m.meta.perpage), 1), m.meta.page > m.meta.pages && (m.meta.page = m.meta.pages), m.paginateEvent = f.getTablePrefix(), m.pager = g(p.table)
                                    .siblings(".m-datatable__pager"), g(m.pager)
                                    .hasClass("m-datatable--paging-loaded") || (g(m.pager)
                                        .remove(), 0 !== m.meta.pages && (f.setDataSourceParam("pagination", {
                                                page: m.meta.page,
                                                pages: m.meta.pages,
                                                perpage: m.meta.perpage,
                                                total: m.meta.total
                                            }), m.callback = m.serverCallback, "function" == typeof e && (m.callback = e), m.addPaginateEvent(), m.populate(), m.meta.page = Math.max(m.meta.page || 1, m.meta.page), g(p)
                                            .trigger(m.paginateEvent, m.meta), m.pagingBreakpoint.call(), g(window)
                                            .resize(m.pagingBreakpoint)))
                            },
                            ...
                            populate: function() {
                                ...
                                m.pager = g("<div/>")
                                    .addClass("m-datatable__pager m-datatable--paging-loaded clearfix");
                                var a = g("<ul/>")
                                    .addClass("m-datatable__pager-nav");
                                m.pagerLayout.pagination = a, g("<li/>")
                                    .append(g("<a/>")
                                        .attr("title", e.first)
                                        .addClass("m-datatable__pager-link m-datatable__pager-link--first")
                                        .append(g("<i/>")
                                            .addClass(t.first))
                                        .on("click", m.gotoMorePage)
                                        .attr("data-page", 1))
                                    .appendTo(a), g("<li/>")
                                    .append(g("<a/>")
                                        .attr("title", e.prev)
                                    ...
                                    .append(g("<input/>")
                                        ...
                                        .on("keyup", function() {
                                            g(this)
                                                .attr("data-page", Math.abs(g(this)
                                                    .val()))
                                        })
                                ...
                                g("<li/>")
                                    ...
                                    .append(g("<a/>")
                                        ...
                                        .append(g("<i/>")
                                            .addClass(t.last))
                                        .on("click", m.gotoMorePage)
                                        .attr("data-page", m.meta.pages))
                                    .appendTo(a), f.getOption("toolbar.items.info") && (m.pagerLayout.info = g("<div/>")
                                        .addClass("m-datatable__pager-info")
                                        .append(g("<span/>")
                                            .addClass("m-datatable__pager-detail"))), g.each(f.getOption("toolbar.layout"), function(t, e) {
                                        g(m.pagerLayout[e])
                                            .appendTo(m.pager)
                                    });
                                var s = g("<select/>")
                                    .addClass("selectpicker m-datatable__pager-size")
                                    .attr("title", f.getOption("translate.toolbar.pagination.items.default.select"))
                                    .attr("data-width", "70px")
                                    .val(m.meta.perpage)
                                    .on("change", m.updatePerpage)
                                    .prependTo(m.pagerLayout.info),
                                    d = f.getOption("toolbar.items.pagination.pageSizeSelect");
                                0 == d.length && (d = [10, 20, 30, 50, 100]), g.each(d, function(t, e) {
                                        var a = e; - 1 === e && (a = "All"), g("<option/>")
                                            .attr("value", e)
                                            .html(a)
                                            .appendTo(s)
                                    }), g(p)
                            ...
                            paste: function() {
                                g.each(g.unique(f.getOption("toolbar.placement")), function(t, e) {
                                    "bottom" === e && g(m.pager)
                                        .clone(!0)
                                        .insertAfter(p.table), "top" === e && g(m.pager)
                                        .clone(!0)
                            ...
                            gotoMorePage: function(t) {
                                if (t.preventDefault(), "disabled" === g(this)
                                    .attr("disabled")) return !1;
                                var e = g(this)
                                    .attr("data-page");
                                return void 0 === e && (e = g(t.target)
                                    .attr("data-page")), m.openPage(parseInt(e)), !1
                            },
                            gotoPage: function(t) {
                                t.preventDefault(), g(this)
                                    .hasClass("m-datatable__pager-link--active") || m.openPage(parseInt(g(this)
                                        .data("page")))
                            },
                            openPage: function(t) {
                                m.meta.page = parseInt(t), g(p)
                                    .trigger(m.paginateEvent, m.meta), m.callback(m, m.meta), g(m.pager)
                                    .trigger("m-datatable--on-goto-page", m.meta)
                            },
                            updatePerpage: function(t) {
                                t.preventDefault(), null === f.getOption("layout.height") && g("html, body")
                                    .animate({
                                        scrollTop: g(p)
                                            .position()
                                            .top
                                    ...
                                    .siblings(".m-datatable__pager")
                                    .removeClass("m-datatable--paging-loaded"), t.originalEvent && (m.meta.perpage = parseInt(g(this)
                                        .val())), g(m.pager)
                                    .find("select.m-datatable__pager-size")
                                    .val(m.meta.perpage)
                                    .attr("data-selected", m.meta.perpage), f.setDataSourceParam("pagination", {
                                        page: m.meta.page,
                                        pages: m.meta.pages,
                                        perpage: m.meta.perpage,
                                        total: m.meta.total
                                    }), g(m.pager)
                                    .trigger("m-datatable--on-update-perpage", m.meta), g(p)
                                    .trigger(m.paginateEvent, m.meta), m.callback(m, m.meta), m.updateInfo.call()
                            },
                            addPaginateEvent: function(t) {
                                g(p)
                                    .off(m.paginateEvent)
                                    .on(m.paginateEvent, function(t, e) {
                                        f.spinnerCallback(!0), m.pager = g(p.table)
                                            .siblings(".m-datatable__pager");
                                        var a = g(m.pager)
                                            .find(".m-datatable__pager-nav");
                                        g(a)
                                            .find(".m-datatable__pager-link--active")
                                            .removeClass("m-datatable__pager-link--active"), g(a)
                                            .find('.m-datatable__pager-link-number[data-page="' + e.page + '"]')
                                            .addClass("m-datatable__pager-link--active"), g(a)
                                            .find(".m-datatable__pager-link--prev")
                                            .attr("data-page", Math.max(e.page - 1, 1)), g(a)
                                            .find(".m-datatable__pager-link--next")
                                            .attr("data-page", Math.min(e.page + 1, e.pages)), g(m.pager)
                                            .each(function() {
                                                g(this)
                                            ...
                                            .find(".m-datatable__pager-nav")
                                            .show(), e.pages <= 1 && g(m.pager)
                                            .find(".m-datatable__pager-nav")
                                            .hide(), f.setDataSourceParam("pagination", {
                                                page: m.meta.page,
                                                pages: m.meta.pages,
                                                perpage: m.meta.perpage,
                                                total: m.meta.total
                                            ...
                                            .find("select.m-datatable__pager-size")
                                            .val(e.perpage)
                                            .attr("data-selected", e.perpage), g(p.table)
                                            .find('.m-checkbox > [type="checkbox"]')
                                            .prop("checked", !1), g(p.table)
                                            .find(".m-datatable__row--active")
                                            .removeClass("m-datatable__row--active"), m.updateInfo.call(), m.pagingBreakpoint.call()
                                    })
                            },
                            updateInfo: function() {
                                ...
                                g(m.pager)
                                    ...
                                    .html(f.dataPlaceholder(f.getOption("translate.toolbar.pagination.items.info"), {
                                        start: t,
                            ...
                            pagingBreakpoint: function() {
                                ...
                                if (0 !== g(a)
                                    ...
                                    g(a)
                                        .find("li")
                                        .show(), g.each(f.getOption("toolbar.items.pagination.pages"), function(t, e) {
                                            if (mUtil.isInResponsiveRange(t)) {
                                                switch (t) {
                                                    ...
                                                    case "tablet":
                                                        ...
                                                        g(o)
                                                            .hide(), m.meta = f.getDataSourceParam("pagination"), m.paginationUpdate();
                                                        break;
                                                    case "mobile":
                                                        g(o)
                                                            .show(), g(a)
                            ...
                            paginationUpdate: function() {
                                var t = g(p.table)
                                    ...
                                    .find(".m-datatable__pager-link--more-next"),
                                    n = g(t)
                                    .find(".m-datatable__pager-link--first"),
                                    o = g(t)
                                    .find(".m-datatable__pager-link--prev"),
                                    i = g(t)
                                    .find(".m-datatable__pager-link--next"),
                                    l = g(t)
                                    .find(".m-datatable__pager-link--last"),
                                    r = g(t)
                                    .find(".m-datatable__pager-link-number"),
                                    s = Math.max(g(r)
                                        .first()
                                ...
                                var d = Math.min(g(r)
                                    .last()
                                    .data("page") + 1, m.meta.pages);
                                g(a)
                                    .each(function(t, e) {
                                        g(a)
                                            .attr("data-page", d)
                                            .show()
                                    }), d === m.meta.pages && d === g(r)
                                    .last()
                                    .data("page") ? g(a)
                                    .parent()
                                    .hide() : g(a)
                                    .parent()
                                    .show(), 1 === m.meta.page ? (g(n)
                                        .attr("disabled", !0)
                                        .addClass("m-datatable__pager-link--disabled"), g(o)
                                        .attr("disabled", !0)
                                        .addClass("m-datatable__pager-link--disabled")) : (g(n)
                                        .removeAttr("disabled")
                                        .removeClass("m-datatable__pager-link--disabled"), g(o)
                                        .removeAttr("disabled")
                                        .removeClass("m-datatable__pager-link--disabled")), m.meta.page === m.meta.pages ? (g(i)
                                        .attr("disabled", !0)
                                        .addClass("m-datatable__pager-link--disabled"), g(l)
                                        .attr("disabled", !0)
                                        .addClass("m-datatable__pager-link--disabled")) : (g(i)
                                        .removeAttr("disabled")
                                        .removeClass("m-datatable__pager-link--disabled"), g(l)
                                        .removeAttr("disabled")
                    ...
                    columnHide: function() {
                        ...
                        g.each(u.columns, function(t, e) {
                            if (void 0 !== e.responsive) {
                                ...
                                mUtil.getBreakpoint(e.responsive.hidden) >= o ? g(n)
                                    .hide() : g(n)
                                    .show(), mUtil.getBreakpoint(e.responsive.visible) <= o ? g(n)
                                    .show() : g(n)
                                    .hide()
                            }
                        })
                    ...
                    setupSubDatatable: function() {
                        ...
                        if ("function" == typeof l && !(0 < g(p.table)
                                .find(".m-datatable__subtable")
                                .length)) {
                            g(p.wrap)
                                .addClass("m-datatable--subtable"), u.columns[0].subtable = !0;
                            var o = function(a) {
                                    a.preventDefault();
                                    var t = g(this)
                                        .closest(".m-datatable__row"),
                                        e = g(t)
                                        .next(".m-datatable__row-subtable");
                                    0 === g(e)
                                        .length && (e = g("<tr/>")
                                            ...
                                            .append(g("<td/>")
                                                ...
                                                .attr("colspan", f.getTotalColumns())), g(t)
                                            .after(e), g(t)
                                            .hasClass("m-datatable__row--even") && g(e)
                                            .addClass("m-datatable__row-subtable--even")), g(e)
                                        .toggle();
                                    var n = g(e)
                                        .find(".m-datatable__subtable"),
                                        o = g(this)
                                        ...
                                        .removeAttr("class");
                                    g(t)
                                        .hasClass("m-datatable__row--subtable-expanded") ? (g(i)
                                            .addClass(f.getOption("layout.icons.rowDetail.collapse")), g(t)
                                            .removeClass("m-datatable__row--subtable-expanded"), g(p)
                                            .trigger("m-datatable--on-collapse-subtable", [t])) : (g(i)
                                            .addClass(f.getOption("layout.icons.rowDetail.expand")), g(t)
                                            .addClass("m-datatable__row--subtable-expanded"), g(p)
                                            .trigger("m-datatable--on-expand-subtable", [t])), 0 === g(n)
                                        .find(".m-datatable")
                                        .length && (g.map(p.dataSet, function(t, e) {
                                                return o === t[u.columns[0].field] && (a.data = t, !0)
                                            }), a.detailCell = n, a.parentRow = t, a.subTable = n, l(a), g(n)
                                            .children(".m-datatable")
                                            .on("m-datatable--on-init", function(t) {
                                                g(e)
                                                    .removeClass("m-datatable__row-loading")
                                            }), "local" === f.getOption("data.type") && g(e)
                                            .removeClass("m-datatable__row-loading"))
                                },
                                i = u.columns;
                            g(p.tableBody)
                    ...
                    autoHide: function() {
                        g(p.table)
                            ...
                            .show(), g(p.tableBody)
                            .each(function() {
                                for (; g(this)[0].offsetWidth < g(this)[0].scrollWidth;) g(p.table)
                                    .find(".m-datatable__row")
                                    .each(function(t) {
                                        var e = g(this)
                                            .find(".m-datatable__cell")
                        ...
                        var t = function(t) {
                            ...
                            var e = g(this)
                                ...
                                .next();
                            if (g(a)
                                .hasClass("m-datatable__row-detail")) g(this)
                                .find("i")
                                .removeClass(f.getOption("layout.icons.rowDetail.expand"))
                                .addClass(f.getOption("layout.icons.rowDetail.collapse")), g(a)
                                .remove();
                            else {
                                g(this)
                                    .find("i")
                                    .removeClass(f.getOption("layout.icons.rowDetail.collapse"))
                                ...
                                g(n)
                                    .each(function() {
                                        ...
                                        g(i)
                                            .append(g('<tr class="m-datatable__row"></tr>')
                                                .append(g('<td class="m-datatable__cell"></td>')
                                                    .append(g("<span/>")
                                                        .css("width", f.offset)
                                                        .append(t.title)))
                                                .append(this))
                                ...
                                g(this)
                                    .prepend(g("<td/>")
                                        ...
                                        .append(g("<a/>")
                                            ...
                                            .append(g("<i/>")
                                                .css("width", "21px")
                                                .addClass(f.getOption("layout.icons.rowDetail.collapse"))))), 0 === g(p.tableHead)
                                    .find(".m-datatable__toggle-detail")
                                    .length ? (g(p.tableHead)
                                        .find(".m-datatable__row")
                                        .first()
                                        .prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'), g(p.tableFoot)
                                        .find(".m-datatable__row")
                                        .first()
                                        .prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : g(p.tableHead)
                                    .find(".m-datatable__toggle-detail")
                                    .find("span")
                                    .css("width", "21px")
                            })
                    ...
                    hoverColumn: function() {
                        g(p.tableBody)
                            .on("mouseenter", ".m-datatable__cell", function() {
                                var t = g(f.cell(this)
                                        .nodes())
                                    .index();
                                g(f.cells()
                                        .nodes())
                                    .removeClass("m-datatable__cell--hover"), g(f.column(t)
                                        .nodes())
                                    .addClass("m-datatable__cell--hover")
                            })
                    },
                    setAutoColumns: function() {
                        f.getOption("data.autoColumns") && (g.each(p.dataSet[0], function(a, t) {
                            ...
                            .find(".m-datatable__row")
                            .remove(), f.setHeadTitle(), f.getOption("layout.footer") && (g(p.tableFoot)
                                .find(".m-datatable__row")
                                .remove(), f.setHeadTitle(p.tableFoot)))
                    },
                    isLocked: function() {
                        return g(p.wrap)
                            .hasClass("m-datatable--lock") || !1
                    },
                    replaceTableContent: function(t, e) {
                        void 0 === e && (e = p.tableBody), g(e)
                            .hasClass("mCustomScrollbar") ? g(e)
                            .find(".mCSB_container")
                            .html(t) : g(e)
                            .html(t)
                    },
                    getExtraSpace: function(t) {
                        return parseInt(g(t)
                            .css("paddingRight")) + parseInt(g(t)
                            .css("paddingLeft")) + (parseInt(g(t)
                            .css("marginRight")) + parseInt(g(t)
                            .css("marginLeft"))) + Math.ceil(g(t)
                    ...
                    getDepth: function() {
                        for (var t = 0, e = p.table; e = g(e)
                            .parents(".m-datatable__table"), t++, 0 < g(e)
                            .length;);
                        return t
                    },
                    ...
                    getTotalColumns: function(t) {
                        return void 0 === t && (t = p.tableBody), g(t)
                            .find(".m-datatable__row")
                            .first()
                            .find(".m-datatable__cell")
                            .length
                    ...
                    getOneRow: function(t, e, a) {
                        void 0 === a && (a = !0);
                        var n = g(t)
                            .find(".m-datatable__row:not(.m-datatable__row-detail):nth-child(" + e + ")");
                    ...
                    sortColumn: function(t, o, i) {
                        ...
                        var l = g(t)
                            ...
                            a = g(t)
                            .closest(".m-datatable__lock")
                            .index(); - 1 !== a && (e = g(p.tableBody)
                            .find(".m-datatable__lock:nth-child(" + (a + 1) + ")")
                            .find(".m-datatable__row"));
                        var n = g(e)
                            .parent();
                        g(e)
                    ...
                    sorting: function() {
                        var i = {
                            ...
                            sortClick: function(t) {
                                ...
                                if ((void 0 === n.sortable || !1 !== n.sortable) && (g(p.tableHead)
                                    ...
                                    f.getObject("field", e) === a && (o = f.getObject("sort", e)), e = {
                                        ...
                                        f.dataRender("sort"), g(p)
                                            .trigger("m-datatable--on-sort", e)
                                    }, 300)
                                }
                            }
                        };
                                    ...
                                    for (var e in t)
                                        if (t.hasOwnProperty(e))
                                            if ("string" == typeof t[e]) {
                                                if (t[e].toLowerCase() == i || -1 !== t[e].toLowerCase()
                                                    .indexOf(i)) return !0
                                            } else if ("object" == typeof t[e]) return o(t[e]);
                                    return !1
                                },
                                i = g(f.getOption("search.input"))
                                .val();
                            ...
                            g.each(a, function(t, e) {
                                if (e = e instanceof Array ? e : [e], n.hasOwnProperty(t)) {
                                    ...
                                    e.forEach(function(t, e) {
                                        t.toString()
                                            .toLowerCase() != a && -1 === a.indexOf(t.toString()
                                                .toLowerCase()) || o++
                                    })
                                }
                    ...
                    resetScroll: function() {
                        void 0 === u.detail && 1 === f.getDepth() && (g(p.table)
                            .find(".m-datatable__row")
                            .css("left", 0), g(p.table)
                            .find(".m-datatable__lock")
                            .css("top", 0), g(p.tableBody)
                            .scrollTop(0))
                    },
                    ...
                    getHiddenDimensions: function(t, e) {
                        ...
                        return o.each(function() {
                            ...
                            .width(), a.outerWidth = g(t)
                            .outerWidth(e), a.innerWidth = g(t)
                            .innerWidth(), a.height = g(t)
                            .height(), a.innerHeight = g(t)
                            .innerHeight(), a.outerHeight = g(t)
                            .outerHeight(e), o.each(function(t) {
                                var e = i[t];
                    ...
                    reload: function() {
                        return function(t, e) {
                            ...
                            u.data.serverFiltering || f.localDataUpdate(), f.dataRender(), g(p)
                                .trigger("m-datatable--on-reloaded")
                        }, f.getOption("search.delay")), p
                    },
                    getRecord: function(n) {
                        return void 0 === p.tableBody && (p.tableBody = g(p.table)
                                .children("tbody")), g(p.tableBody)
                    ...
                    getColumn: function(t) {
                        return f.setSelectedRecords(), p.API.value = g(p.API.record)
                            .find('[data-field="' + t + '"]'), p
                    },
                    destroy: function() {
                        g(p)
                        ...
                        return g(p)
                            .replaceWith(t), g(p = t)
                            .trigger("m-datatable--on-destroy"), f.isInit = !1, t = null
                    },
                    sort: function(t, e) {
                        ...
                        return f.setDataSourceParam("sort", a), setTimeout(function() {
                            f.dataRender("sort"), g(p)
                                .trigger("m-datatable--on-sort", a), g(p.tableHead)
                                .find(".m-datatable__cell > span > i")
                                .remove()
                        }, 300), p
                    },
                    getValue: function() {
                        return g(p.API.value)
                            .text()
                    },
                    setActive: function(t) {
                        "string" == typeof t && (t = g(p.tableBody)
                                .find('.m-checkbox--single > [type="checkbox"][value="' + t + '"]')), g(t)
                            .prop("checked", !0);
                        var e = g(t)
                            .closest(".m-datatable__row")
                        ...
                        g(e)
                            ...
                            .trigger("m-datatable--on-check", [n])
                    },
                    setInactive: function(t) {
                        ...
                        g(e)
                            ...
                            .trigger("m-datatable--on-uncheck", [n])
                    },
                    ...
                    setSelectedRecords: function() {
                        return p.API.record = g(p.tableBody)
                            .find(".m-datatable__row--active"), p
                    },
                    getSelectedRecords: function() {
                        return f.setSelectedRecords(), p.API.record = p.rows(".m-datatable__row--active")
                            .nodes(), p.API.record
                    },
                    ...
                    destroyScroller: function(t) {
                        void 0 === t && (t = p.tableBody), g(t)
                            .each(function() {
                                if (g(this)
                                    .hasClass("mCustomScrollbar")) try {
                    ...
                    row: function(t) {
                        return f.rows(t), f.nodeTr = f.recentNode = g(f.nodeTr)
                            .first(), p
                    },
                    rows: function(t) {
                        return f.nodeTr = f.recentNode = g(p.tableBody)
                            .find(t)
                            .filter(".m-datatable__row"), p
                    },
                    column: function(t) {
                        return f.nodeCols = f.recentNode = g(p.tableBody)
                            .find(".m-datatable__cell:nth-child(" + (t + 1) + ")"), p
                    },
                    columns: function(t) {
                        var e = p.table;
                        ...
                        return 0 < a.length ? f.nodeCols = f.recentNode = a : f.nodeCols = f.recentNode = g(e)
                            .find(t)
                            .filter(".m-datatable__cell"), p
                    },
                    cell: function(t) {
                        return f.cells(t), f.nodeTd = f.recentNode = g(f.nodeTd)
                            .first(), p
                    },
                    cells: function(t) {
                        var e = g(p.tableBody)
                            .find(".m-datatable__cell");
                        return void 0 !== t && (e = g(e)
                            .filter(t)), f.nodeTd = f.recentNode = e, p
                    },
                    remove: function() {
                        return g(f.nodeTr.length) && f.nodeTr === f.recentNode && g(f.nodeTr)
                            .remove(), f.layoutUpdate(), p
                    },
                    visible: function(t) {
                        if (g(f.recentNode.length)) {
                            ...
                            if (f.recentNode === f.nodeCols) {
                                ...
                                if (f.isLocked()) {
                                    var n = g(f.recentNode)
                                        .closest(".m-datatable__lock--scroll")
                                        .length;
                                    n ? a += e.left.length + 1 : g(f.recentNode)
                                        .closest(".m-datatable__lock--right")
                                        .length && (a += e.left.length + n + 1)
                                }
                            }
                            t ? (f.recentNode === f.nodeCols && delete u.columns[a].responsive, g(f.recentNode)
                                .show()) : (f.recentNode === f.nodeCols && f.setOption("columns." + a + ".responsive", {
                                    hidden: "xl"
                                }), g(f.recentNode)
                                .hide()), f.redraw()
                        }
                ...
                if (g.each(f, function(t, e) {
                    ...
                    if ("string" == typeof u) {
                        var t = u;
                        void 0 !== (p = g(this)
                            .data("mDatatable")) && (u = p.options, f[t].apply(this, Array.prototype.slice.call(arguments, 1)))
                    } else p.data("mDatatable") || g(this)
                        .hasClass("m-datatable--loaded") || (p.dataSet = null, p.textAlign = {
                                left: "m-datatable__cell--left",
                                center: "m-datatable__cell--center",
                                right: "m-datatable__cell--right"
                            }, u = g.extend(!0, {}, g.fn.mDatatable.defaults, u), p.options = u, f.init.apply(this, [u]), g(p.wrap)
                            .data("mDatatable", p));
                else void 0 === (p = g(this)
                    .data("mDatatable")) && g.error("mDatatable not initialized"), u = p.options;
                return p
            }
        ...
        var a = {
            ...
            l = {
                construct: function(t) {
                    return mUtil.data(n)
                        .has("dropdown") ? o = mUtil.data(n)
                        .get("dropdown") : (l.init(t), l.setup(), mUtil.data(n)
                            .set("dropdown", o)), o
                },
                init: function(t) {
                ...
                setContent: function(t) {
                    t = mUtil.find(n, ".m-dropdown__content")
                        .innerHTML = t;
                    return o
                },
                show: function() {
                    ...
                    if (o.layout.arrow && l.adjustArrowPos(), l.eventTrigger("beforeShow"), l.hideOpened(), mUtil.addClass(n, "m-dropdown--open"), mUtil.isMobileDevice() && o.options.mobileOverlay) {
                        ...
                        mUtil.addClass(e, "m-dropdown__dropoff"), mUtil.css(e, "z-index", t), mUtil.data(e)
                            .set("dropdown", n), mUtil.data(n)
                            .set("dropoff", e), mUtil.addEvent(e, "click", function(t) {
                ...
                hideClicked: function() {
                    !1 !== l.eventTrigger("beforeHide") && (mUtil.removeClass(n, "m-dropdown--open"), mUtil.data(n)
                        .remove("dropoff"), o.open = !1, l.eventTrigger("afterHide"))
                },
                hide: function(t) {
...
mUtil.on(document, '[m-dropdown-toggle="click"] .m-dropdown__toggle', "click", function(t) {
    ...
    e && ((mUtil.data(e)
            .has("dropdown") ? mUtil.data(e)
            .get("dropdown") : new mDropdown(e))
    ...
    if (mUtil.isDesktopDevice()) {
        this && ((mUtil.data(this)
                .has("dropdown") ? mUtil.data(this)
                .get("dropdown") : new mDropdown(this))
        ...
        if (void 0 !== a) {
            var n = {
                ...
                o = {
                    construct: function(t) {
                        return mUtil.data(a)
                            .has("header") ? i = mUtil.data(a)
                            .get("header") : (o.init(t), o.build(), mUtil.data(a)
                                .set("header", i)), i
                    },
                    init: function(t) {
        ...
        if (d) {
            var n = {
                ...
                f = {
                    construct: function(t) {
                        return mUtil.data(d)
                            .has("menu") ? p = mUtil.data(d)
                            .get("menu") : (f.init(t), f.reset(), f.build(), mUtil.data(d)
                                .set("menu", p)), p
                    },
                    init: function(t) {
                    ...
                    handleSubmenuDropdownClose: function(t, e) {
                        if ("accordion" !== f.getSubmenuMode()) {
                            ...
                            if (0 < a.length && !1 === mUtil.hasClass(e, "m-menu__toggle") && 0 === e.querySelectorAll(".m-menu__toggle")
                                .length)
                    ...
                    resumeDropdownHover: function() {
                        return (new Date)
                            .getTime() > p.pauseDropdownHoverTime
                    },
                    resetActiveItem: function(t) {
                        for (var e, a, n = 0, o = (e = d.querySelectorAll(".m-menu__item--active"))
                                .length; n < o; n++) {
                            var i = e[0];
                            mUtil.removeClass(i, "m-menu__item--active"), mUtil.hide(mUtil.child(i, ".m-menu__submenu"));
                            for (var l = 0, r = (a = mUtil.parents(i, ".m-menu__item--submenu"))
                                    .length; l < r; l++) {
                                var s = a[n];
...
document.addEventListener("click", function(t) {
    var e;
    if (e = mUtil.get("body")
        .querySelectorAll('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]'))
        for (var a = 0, n = e.length; a < n; a++) {
            var o = e[a].closest(".m-menu__nav")
                .parentNode;
            if (o) {
                var i, l = mUtil.data(o)
                    .get("menu");
                if (!l) break;
        ...
        if (a) {
            var o = {},
                i = {
                    construct: function(t) {
                        return mUtil.data(a)
                            .has("offcanvas") ? l = mUtil.data(a)
                            .get("offcanvas") : (i.init(t), i.build(), mUtil.data(a)
                                .set("offcanvas", l)), l
                    },
                    init: function(t) {
        ...
        if (d) {
            var a = {
                ...
                o = {
                    construct: function(t) {
                        return mUtil.data(d)
                            .has("portlet") ? s = mUtil.data(d)
                            .get("portlet") : (o.init(t), o.build(), mUtil.data(d)
                                .set("portlet", s)), s
                    },
                    init: function(t) {
                        s.element = d, s.events = [], s.options = mUtil.deepExtend({}, a, t), s.head = mUtil.child(d, ".m-portlet__head"), s.foot = mUtil.child(d, ".m-portlet__foot"), mUtil.child(d, ".m-portlet__body") ? s.body = mUtil.child(d, ".m-portlet__body") : 0 !== mUtil.child(d, ".m-form")
                            .length && (s.body = mUtil.child(d, ".m-form"))
                    },
                    build: function() {
                    ...
                    removeTooltips: function() {
                        if (s.options.tooltips) {
                            var t = mUtil.find(s.head, "[m-portlet-tool=remove]");
                            t && mUtil.data(t)
                                .has("tooltip") && mUtil.data(t)
                                .get("tooltip")
                                .dispose();
                            var e = mUtil.find(s.head, "[m-portlet-tool=reload]");
                            e && mUtil.data(e)
                                .has("tooltip") && mUtil.data(e)
                                .get("tooltip")
                                .dispose();
                            var a = mUtil.find(s.head, "[m-portlet-tool=toggle]");
                            a && mUtil.data(a)
                                .has("tooltip") && mUtil.data(a)
                                .get("tooltip")
                                .dispose();
                            var n = mUtil.find(s.head, "[m-portlet-tool=fullscreen]");
                            n && mUtil.data(n)
                                .has("tooltip") && mUtil.data(n)
                                .get("tooltip")
                                .dispose()
                        }
                    },
                    ...
                    collapse: function() {
                        if (!1 !== o.eventTrigger("beforeCollapse")) {
                            ...
                            t && mUtil.data(t)
                                .has("tooltip") && mUtil.data(t)
                                .get("tooltip")
                                .updateTitleContent(s.options.tools.toggle.expand)
                        }
                    },
                    expand: function() {
                        if (!1 !== o.eventTrigger("beforeExpand")) {
                            ...
                            t && mUtil.data(t)
                                .has("tooltip") && mUtil.data(t)
                                .get("tooltip")
                                .updateTitleContent(s.options.tools.toggle.collapse)
                        }
                    },
        ...
        if (a) {
            var l = {
                ...
                r = {
                    construct: function(t) {
                        return mUtil.data(a)
                            .has("quicksearch") ? n = mUtil.data(a)
                            .get("quicksearch") : (r.init(t), r.build(), mUtil.data(a)
                                .set("quicksearch", n)), n
                    },
                    init: function(t) {
        ...
        if (a) {
            var i = {
                ...
                l = {
                    construct: function(t) {
                        return mUtil.data(a)
                            .has("scrolltop") ? o = mUtil.data(a)
                            .get("scrolltop") : (l.init(t), l.build(), mUtil.data(a)
                                .set("scrolltop", o)), o
                    },
                    init: function(t) {
        ...
        if (a) {
            var o = {
                ...
                l = {
                    construct: function(t) {
                        return mUtil.data(a)
                            .has("toggle") ? n = mUtil.data(a)
                            .get("toggle") : (l.init(t), l.build(), mUtil.data(a)
                                .set("toggle", n)), n
                    },
                    init: function(t) {
        ...
        if (o) {
            var a = {
                ...
                r = {
                    construct: function(t) {
                        return mUtil.data(o)
                            .has("wizard") ? l = mUtil.data(o)
                            .get("wizard") : (r.init(t), r.build(), mUtil.data(o)
                                .set("wizard", l)), l
                    },
                    init: function(t) {
...
$.notifyDefaults({
        ...
        errorPlacement: function(t, e) {
            var a = 0 < $(e)
                .closest(".m-form__group-sub")
                .length ? $(e)
                .closest(".m-form__group-sub") : $(e)
                .closest(".m-form__group"),
                n = a.find(".m-form__help");
            0 === a.find(".form-control-feedback")
                .length && (0 < n.length ? n.before(t) : 0 < $(e)
                    .closest(".input-group")
                    .length ? $(e)
                    .closest(".input-group")
                    .after(t) : $(e)
        ...
        success: function(t, e) {
            var a = 0 < $(t)
                ...
                .closest(".m-form__group-sub") : $(t)
                .closest(".m-form__group");
            a.removeClass("has-danger"), a.find(".form-control-feedback")
                .remove()
        }
    ...
    function(l) {
        l.fn.mDatatable = l.fn.mDatatable || {}, l.fn.mDatatable.checkbox = function(n, o) {
            var i = {
                ...
                unselectedRows: [],
                init: function() {
                    i.selectorEnabled() && (o.vars.requestIds && n.setDataSourceParam(o.vars.requestIds, !0), i.selectedAllRows = n.getDataSourceParam(o.vars.selectedAllRows), l(n)
                        .on("m-datatable--on-layout-updated", function(t, e) {
                            e.table == l(n.wrap)
                                .attr("id") && n.ready(function() {
                ...
                initEvent: function() {
                    l(n.tableHead)
                        ...
                        .click(function(t) {
                            if (i.selectedRows = i.unselectedRows = [], n.stateRemove("checkbox"), l(this)
                                .is(":checked") ? i.selectedAllRows = !0 : i.selectedAllRows = !1, !o.vars.requestIds) {
                                l(this)
                                    .is(":checked") && (i.selectedRows = l.makeArray(l(n.tableBody)
                            ...
                            n.setDataSourceParam(o.vars.selectedAllRows, i.selectedAllRows), l(n)
                                .trigger("m-datatable--on-click-checkbox", [l(this)])
                        }), l(n.tableBody)
                        .find('.m-checkbox--single > [type="checkbox"]')
                        .click(function(t) {
                            var e = l(this)
                                .val();
                            l(this)
                                .is(":checked") ? (i.selectedRows.push(e), i.unselectedRows = i.remove(i.unselectedRows, e)) : (i.unselectedRows.push(e), i.selectedRows = i.remove(i.selectedRows, e)), !o.vars.requestIds && i.selectedRows.length < 1 && l(n.tableHead)
                                .find('.m-checkbox--all > [type="checkbox"]')
                                .prop("checked", !1);
                            var a = {};
                            a.selectedRows = l.unique(i.selectedRows), a.unselectedRows = l.unique(i.unselectedRows), n.stateKeep("checkbox", a), l(n)
                                .trigger("m-datatable--on-click-checkbox", [l(this)])
                        })
                },
                initSelect: function() {
                    i.selectedAllRows && o.vars.requestIds ? (n.hasClass("m-datatable--error") || l(n.tableHead)
                        .find('.m-checkbox--all > [type="checkbox"]')
                        .prop("checked", !0), n.setActiveAll(!0), i.unselectedRows.forEach(function(t) {
                            n.setInactive(t)
                        })) : (i.selectedRows.forEach(function(t) {
                            n.setActive(t)
                        }), !n.hasClass("m-datatable--error") && l(n.tableBody)
                        .find('.m-checkbox--single > [type="checkbox"]')
                        .not(":checked")
                        .length < 1 && l(n.tableHead)
                        .find('.m-checkbox--all > [type="checkbox"]')
                        .prop("checked", !0))
                },
    ...
    return {
        ...
        initHeader: function() {
            ...
            e = mUtil.get("m_header"), a = {
                ...
                .click(function() {
                    $("body")
                        .toggleClass("m-topbar--on")
                }), setInterval(function() {
                    $("#m_topbar_notification_icon .m-nav__link-icon")
                        .addClass("m-animate-shake"), $("#m_topbar_notification_icon .m-nav__link-badge")
                        .addClass("m-animate-blink")
                }, 3e3), setInterval(function() {
                    $("#m_topbar_notification_icon .m-nav__link-icon")
                        .removeClass("m-animate-shake"), $("#m_topbar_notification_icon .m-nav__link-badge")
                        .removeClass("m-animate-blink")
                }, 6e3), 0 !== $("#m_quicksearch")
                .length && (quicksearch = new mQuicksearch("m_quicksearch", {
        ...
        initAside: function() {
            var t, e, a;
            t = mUtil.get("m_aside_left"), e = mUtil.hasClass(t, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", o = new mOffcanvas("m_aside_left", {
                    baseClass: e,
                    overlay: !0,
                ...
                .find(".m-menu__item--submenu-fullheight")
                .each(function() {
                    var t = $(this)
                        .find("> .m-menu__submenu > .m-menu__wrapper");
                    if (mUtil.isInResponsiveRange("tablet-and-mobile")) mApp.destroyScroller(t);
                    else {
                        var e = mUtil.getViewPort()
                            .height;
                        mApp.initScroller(t, {
                            height: e
                        }, !0)
                ...
                .data("m-menu-dropdown") ? "dropdown" : "accordion", n = new mMenu("m_ver_menu", {
                    submenu: {
                        desktop: {
                            default: a,
                            state: {
            ...
            ! function() {
                ...
                if (0 !== e.length) {
                    var a = e.find(".m-messenger__messages"),
                        t = function() {
                            var t = n.outerHeight(!0) - o.outerHeight(!0) - e.find(".m-messenger__form")
                                .outerHeight(!0) - 120;
