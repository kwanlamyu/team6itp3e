...
// $thirdBalanceDate = $_POST["thirdBalanceDate"];
            ...
            <script type="text/javascript">
                ...
                formElement += "<p id='helpingWords'><b>Helping Keys:</b><br></p> <button class='btn btn-brand' type='button' id='addManualBtn'>Add Manual Input Boxes</button><br/><br/>\n\
                                <p id='inputField'> Manual Accounts: <input class='form-control' type='text' id='mAccount0'> <br> Values: <input class='form-control' type='text' id='mValue0'>";

                //    formElement += "<select id='dropdownYear'>";

                for (var t = 0; t < yearsCount; t++) {
                    //        formElement += "<option value='" + years[t] + "'>" + years[t] + "</option>";
                    formElement += years[t] +"<input class='form-control' type='radio' name='0' id='date0" + t + "' value='" + years[t] + "'>" ;
                }

                //    formElement += "</select>";

                formElement += "<br><br></p><button class='btn btn-success' type='button' id='nextBtn'>Next</button>\n\
