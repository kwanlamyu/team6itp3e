				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="login_validation.php" id="login" name="login" method="POST">
								...
								<div class="m-login__form-action">
									<button type="submit" name="loginbtt" id="logBtn" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">
										LOGIN
									</button>
								</div>
							</form>
						...
						<div class="m-login__signup">
							...
							<form id="registerStudent" name="registration" class="m-login__form m-form" action="registration.php" method="POST">
								...
								<div class="m-login__form-action">
									<button type="submit" name="registerButton" id="registerButton"class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">
										Sign Up
									</button>
									&nbsp;&nbsp;
