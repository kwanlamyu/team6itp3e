...
--
-- Host: localhost:‘8889’
-- Generation Time: Jul 20, 2018 at 08:52 AM
...
('201816715D', 'haha photo co', '000000', '2018-07-19 13:29:38', 'Jerome'),
('201817232E', 'test company', '000000', '2018-07-19 13:29:03', 'Jerome'),
('201818134F', 'SoulessCreation Co', '000000', '2018-07-19 13:30:48', 'Jerome');
...
('jerome', 'jerome@itp.com', '$2y$10$7b0saxGRxTnkJVX1B39Ohez/cGG4KP1Onb6Qztbd5n3QNgNIUnEn6', 2, 'jerome pte ltd'),
('kok hoe', 'kokhoe@itp.com', '$2y$10$lYM7uXp6BxbhH3TcPySYKeTQKqBbpepnSXFgEN.PBiUtqV1.NXWYO', 3, 'kok hoe pte ltd'),
('phoebe', 'phoebe@itp.com', '$2y$10$OF3ZLHIHZWKFdcqIvGCSJuoTlxYK5URGj2vTGA9RfAFuPp2uzLAMW', 1, 'phoebe pte ltd'),
('souless', 'soulesscreation@itp.com', '$2y$10$vpTzby5AuBwGUIBFxQPH0ueqxDtRmD6hRu.V6CvA.MRWIGHc/uOhe', 2, 'SoulessCreation Co'),
('super admin', 'superadmin@itp.com', '$2y$10$8GkjKqEc9XcLrvRem1NByeg0qA6nplTsGVPoHUFkAmNpzI1J/PEWa', 1, '3E accounting'),
('test_user', 'test_user@itp.com', '$2y$10$44U9erqvq.iLkhTaZgkBcuYL86t97.5zOCBQazXMJYDNoFkKsX7sG', 3, ''),
('weekokhoe', '1602494@sit.singaporetech.edu.sg', '$2y$10$TFmYAE4gbvEtgoYbBveIg.iUrfvkAAXJv.zzU29n4HLXpHMfS65c.', 2, 'kok hoe inc'),
('yok yee', 'yokyee@itp.com', '$2y$10$87IwD20cH4eIYHmTDa4Dg..Luy5D5kkvWWrnXH7gLDxeg1OsS3jnu', 3, 'yok yee pte ltd');
...
('201817232E', 'Jerome', 'kok hoe', 3),
('20180525', 'phoebe', 'phoebe', 1),
('201816715D', 'Jerome', 'test_user', 3),
('201816715D', 'Jerome', 'yok yee', 3);
...
--
ALTER TABLE `history`
  ADD CONSTRAINT `fk_account_history1` FOREIGN KEY (`account_UEN`,`account_user_username`) REFERENCES `account` (`UEN`, `user_username`) ON DELETE NO ACTION ON UPDATE NO ACTION;
